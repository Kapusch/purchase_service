...
namespace Magasin.Module.Tools
{
    public partial class ClientInformation : Form
    {
        ...
        private void ClientInformation_Load(object sender, EventArgs e)
        {
            ...
            cbBank.DataSource = Service.GetService.GetBanks();
            cbType.DataSource = Service.GetService.GetCardType();
        }
        ...
        private void btnAdd_Click(object sender, EventArgs e)
        {
            ...
            var result = Service.GetService.AddCarteForClient(currentClient.clientId, numero, tbExpirationDate.Text, crypto, cbType.Text, cbBank.Text);
